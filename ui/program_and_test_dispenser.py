...
def test(ll):
    ...
    if ll:
        while True:
            line = input("Press Enter to check the liquid level sensor. Type 'q' to move on to the next dispenser... ")
            if line == 'q':
                break
...
while True:
    ...
    line = input("Press Enter to program/test the next dispenser.... Type 'q' to exit.")
    if line == 'q':
        break
