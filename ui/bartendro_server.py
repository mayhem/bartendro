...
RPI_CPU_IDS_FOR_TTYAMA0 = [
    "0002", "0003", "0004", "0005", "0006", "0007", "0008", "0009", "000d", "000e", "000f", "0010", "0013", "0011", "0012",
    "a01041", "a21041", "900092"
]
...
if os.path.exists("version.txt"):
    ...
    if version:
        version = "git commit " + str(version[:10], "utf-8")
    else:
        version = "[unknown]"
